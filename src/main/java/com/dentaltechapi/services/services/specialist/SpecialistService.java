package com.dentaltechapi.services.services.specialist;
...
import com.dentaltechapi.services.services.officedatetime.OfficeDateTimeService;
    ...
    public void createNewSpecialist(SpecialistModel specialistModel) {
        try {
            ...
            for (SpecialtyModel specialty : specialistModel.getSpecialties()) {
                SpecialtyModel persistedSpecialty = specialtyService.findById(specialty.getId());
